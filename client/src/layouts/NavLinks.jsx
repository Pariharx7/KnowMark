...
const NavLinks = ({ label, Icon, link, onClick }) => {
    const active =
        'flex w-full items-center space-x-3 rounded-md border-transparent bg-primary/5 dark:bg-primary-400/20 px-4 py-2.5 text-sm font-medium text-[var(--primary)] dark:text-white ring-transparent transition-colors duration-100';
    const inactive =
